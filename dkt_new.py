#   https://github.com/mmkhajah/dkt/pulls
...
def main():
    ...
    parser.add_argument('--epochs', '-e', type=int, help='Number of epochs.', default=50, required=False)
    ...
    def loss_function(y_true, y_pred):
        ...
        rel_pred = K.sum(y_pred * skill, axis=2)
